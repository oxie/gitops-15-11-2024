    ...
    <div className="p-6 border-b border-slate-700/50">
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-lg bg-gradient-to-br from-gold-500/10 to-gold-600/5 transition-all duration-300 will-change-transform group-hover:from-gold-500/20 group-hover:to-gold-600/10">
            <Icon className="h-5 w-5 text-gold-400 flex-shrink-0 transition-transform duration-300 will-change-transform group-hover:scale-110" />
          </div>
...
const CategoryItem = memo(function CategoryItem({ 
  ...
  return (
    <motion.div 
      ...
      className="group/item flex items-center space-x-2 pl-2 py-1 rounded-md transition-all duration-200 hover:bg-slate-800/70 will-change-transform"
    >
...
const HoverEffects = memo(function HoverEffects() {
  return (
    <div className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-500 pointer-events-none will-change-transform">
...
const CategoryGroup = memo(function CategoryGroup({ 
  ...
  return (
    <div className="group relative h-full">
      <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-gold-500/10 to-gold-600/10 opacity-0 group-hover:opacity-100 transition-all duration-500 blur-xl will-change-transform" />
      ...
      <motion.div
        ...
        className="relative h-full rounded-lg bg-slate-800/30 backdrop-blur-xl border border-slate-700/50 group-hover:border-gold-500/50 group-hover:bg-slate-800/40 transition-all duration-500 group-hover:shadow-[0_0_30px_rgba(250,189,0,0.15)] will-change-transform"
      >
